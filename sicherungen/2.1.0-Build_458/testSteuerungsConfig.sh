# The Konnektor-IP
#export KONNEKTOR_IP=10.33.128.110
#export KONNEKTOR_IP=192.168.2.100
export KONNEKTOR_IP=10.33.128.207

export WP1_CETPServerIP=10.33.128.100
# The name of the "konn-wan" router interface 
export IF_ROUTER_KONN_WAN=eth1

export HEISE_IP=193.99.144.80
export WP2_ROOT_PASSWORD=123456
export WP3_ROOT_PASSWORD=123456
...
#export EXECUTION_MODUS=EXECUTION_1_5_0_b209_CampusX_OL
#export EXECUTION_MODUS=EXECUTION_1_5_1_b62_CampusX
#export EXECUTION_MODUS=EXECUTION_1_5_2_b20_225_Paul
#export EXECUTION_MODUS=EXECUTION_1_5_2_b20_225_CampusX
#export EXECUTION_MODUS=EXECUTION_1_5_2_b20_225_CampusX_1
#export EXECUTION_MODUS=EXECUTION_1_5_2_b24_225_CampusX_v3
#export EXECUTION_MODUS=EXECUTION_1_5_2_b24_225_CampusX_v4
#export EXECUTION_MODUS=EXECUTION_1_5_2_b33_225_CampusX
#export EXECUTION_MODUS=EXECUTION_1_5_2_b37_226_TEMPORELL_CampusX
#export EXECUTION_MODUS=EXECUTION_1_5_2_b37_225_CampusX

export EXECUTION_MODUS=EXECUTION_2_1_0_b458_226_CampusX
...
export sqlite3_Konnektor=$(ping 10.10.8.15 -c1 -W1 && sshpass -p123456 ssh -p2222 root@10.10.8.15 'ls /opt/secure/current/extern/bin/ | grep sqlite3') &>/dev/null
...
#export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 1.5.2 - Build: 33 - Revision: ecbdcaabad:2.2.5"
#export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 1.5.2 - Build: 37 - Revision: 0d277ee49e:2.2.6"
#export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 1.5.2 - Build: 37 - Revision: 0d277ee49e:2.2.4"

#export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 2.1.0 - Build: 360 - Revision: 94352d9234:2.2.6"
export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 2.1.0 - Build: 452 - Revision: e6658d09c8:2.2.6"
export KONNEKTOR_VERSION="Telekom-Konnektor EBK (TKONEBK) in der Produktversion 2.1.0 - Build: 458 - Revision: 57f7a5b14d:2.2.6"
...
#~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/konnektor-api/konnektor-api-1.13.19.jar
#~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/konnektor-api/konnektor-api-1.13.10.jar
LIB_KONNEKTOR_API=\
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/konnektor-api/konnektor-api-2.1.0.456.jar
#
...
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/guava-25.0-jre.jar:\
...
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/client-combined-3.141.59.jar:\
#~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/byte-buddy-1.8.3.jar:\
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/byte-buddy-1.8.15.jar:\
...
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/okhttp-3.11.0.jar:\
#~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/okio-1.13.0.jar:\
~/workspace.docker_branch/TestSuite-Konnektor-T-Systems/lib/selenium/okio-1.14.0.jar:\
$ECLIPSE_PLUGINS_DIR/*:\
$LIB_KONNEKTOR_API:\
$LIB_FHI_CTSIM_CLIENT
...
#export TESTER_NODE=192.168.2.251

# The localhost-IP
export LOCALHOST_IP=10.33.128.100
#export LOCALHOST_IP=192.168.2.251
...
#export LOCALHOST_MAC=00:50:b6:18:2d:42

export LOCALHOST_HOSTNAME=CampusX
...
#export LAN_DHCP_SERVER=192.168.2.1
...
export WP1_TMP_IP=10.33.128.100
#export WP1_TMP_IP=192.168.2.251
...
export WP2_TMP_IP=10.33.128.25
#export WP2_TMP_IP=192.168.2.25
#export WP2_TMP_IP=192.168.2.211

# Temporal IP for WP2 to use while playing with the DHCP-Server of the test lab
#export WP3_TMP_IP=10.33.128.4
export WP3_TMP_IP=10.33.128.6
export WP3_TMP_IP=10.33.128.26
#export WP3_TMP_IP=192.168.2.26
#export WP3_TMP_IP=192.168.2.222

# The MAC Adress of the Konnektor interface that is inside the LAN
#export KONNEKTOR_LAN_MAC=00:30:d6:15:9f:6a
#export KONNEKTOR_LAN_MAC=00:30:d6:16:62:9b		00:30:d6:1d:4c:bf	00:30:d6:1d:3a:68
###export KONNEKTOR_LAN_MAC=00:30:d6:1d:4c:bf
#224
#export KONNEKTOR_LAN_MAC=00:30:d6:16:62:9b
#225
#export KONNEKTOR_LAN_MAC=00:30:d6:1d:4c:94
#226
export KONNEKTOR_LAN_MAC=00:30:d6:1f:53:d8
...
#224
#export KONNEKTOR_WAN_MAC=00:30:d6:16:62:0b
#225
#export KONNEKTOR_WAN_MAC=00:30:d6:1d:3a:68
#226
export KONNEKTOR_WAN_MAC=00:30:d6:1f:13:8c
...
# Additional DNS test entry
export DNS_TI_TEST2=konzentrator-test.vpn-zugd.telematik-test
...
# The management/control IP of the SIS DNS 
export DNS_SIS_IP=10.60.5.35
...
export NET_TI_OFFENE_FD_IP=172.30.0.2
...
#export NET_INTRANET_IP=192.168.122.1

# The length of the network prefix of NET_INTRANET
export NET_INTRANET_PREFIX_LENGTH=24

# The management/control IP of the Trust Anchor Provider
export TRUST_ANCHOR_IP=10.60.5.7
...
export START_PCAP_LOGGING_KT_A="no"
export START_PCAP_LOGGING_KT_B="no"
export START_PCAP_LOGGING_KT_C="no"
...
#export WP2_LAN_IP=192.168.2.210
#export WP3_LAN_IP=192.168.2.221

######################################################

export IntranetTestNextHop=10.33.122.221
export IntranetTestIpAddr=10.33.122.0
#export IntranetTestNextHop=192.168.122.221
#export IntranetTestIpAddr=192.168.122.0
...
# WP2 Intranet IP
export WP2_INTRANET_IP=10.33.128.210
#export WP2_INTRANET_IP=192.168.2.210
# WP3 Management IP
export WP3_MNG_IP=10.60.5.91
# WP3 Management IP
export WP3_INTRANET_IP=10.33.128.221
#export WP3_INTRANET_IP=192.168.2.221
...
# MAC-Adressen in Docker-Umgebung werden dynamisch generiert
{
	...
	*)
	...
	LAN_MAC=`sshpass -p$MASTER_PASSWD ssh -o ConnectTimeout=2 root@$WP_MANAGEMENT_IP "cat /sys/devices/virtual/net/eth0/address"`
}
 
# The MAC Adress of the WP2 interface
get_wp_lan_mac 2
export WP2_LAN_MAC=$LAN_MAC

# The MAC Adress of the WP3 interface
get_wp_lan_mac 3
export WP3_LAN_MAC=$LAN_MAC
